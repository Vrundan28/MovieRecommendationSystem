            ...
            <div className="userprofile_container">
                ...
                <div className="userprofile_right_details">
                    <div className="userprofile_content">
                        <div className="userprofile_UserName">{curruser.userName}</div>
                        <div className="userprofile_Name">{curruser.first_name} {curruser.last_name}</div>
                        <div className="userprofile_email">{curruser.email}</div>
                    </div>
                </div>
